...
var CELULAR_EMPRESA = "5532988634755";
//var CELULAR_EMPRESA = "5532988494282";
...
cardapio.metodos = {
  ...
  //botão voltar da modal
  voltarEtapa: () => {
    let etapa = $(".etapa.active").length;
    cardapio.metodos.carregarEtapa(etapa - 1);
  },

  //carrega itens selecionado dentro do carrinho
  carregarCarrinho: () => {
    ...
    if (MEU_CARRINHO.length > 0) {
      ...
      $.each(MEU_CARRINHO, (i, e) => {
        ...
        //adiciona o template com as variaveis dinamicas
  ...
  removerItemCarrinho: (id) => {
    //filtra o id do item que vai ser excluido e retorna todo os item menos o item exlcuido.
...
cardapio.templates = {
  item: `
    <div class="col-12 col-lg-3 col-md-3 col-sm-6 col-one mb-5 animated fadeInUp">
 ...
 <dic class="add-carrinho">
    <span 
     class="btn-menos" 
     onclick="cardapio.metodos.diminuirQuantidadeCarrinho('\${id}')">
        <i class="fas fa-minus"></i>
    </span>
    <span 
      class="add-numero-itens" 
    ...
    <span 
     class="btn-mais" 
     onclick="cardapio.metodos.aumentarQuantidadeCarrinho('\${id}')">
        <i class="fas fa-plus"></i>
    </span>
    <span 
      class="btn btn-remove" 
      onclick="cardapio.metodos.removerItemCarrinho('\${id}')">
